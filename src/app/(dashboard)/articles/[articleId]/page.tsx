...
import { getArticleById, getBrandById } from "@/lib/mock-data";
...
export default function ArticleEditorPage() {
  ...
  const brand = article ? getBrandById(article.brandId) : null;
            ...
            <section>
              ...
              <div className="space-y-1">
                {workflowSteps.map((step, index) => {
                  const state = getStepState(article.status, step.status);
                  return (
